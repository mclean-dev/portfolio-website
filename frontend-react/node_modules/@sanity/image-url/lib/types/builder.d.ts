import { AutoMode, CropMode, FitMode, ImageFormat, ImageUrlBuilderOptions, ImageUrlBuilderOptionsWithAliases, Orientation, SanityClientLike, SanityImageSource, SanityProjectDetails } from '@sanity/image-url/lib/types/types';
export default function urlBuilder(options?: SanityClientLike | SanityProjectDetails): ImageUrlBuilder;
