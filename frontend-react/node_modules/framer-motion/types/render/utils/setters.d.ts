...
import { Target, TargetAndTransition, TargetResolver, TargetWithKeyframes, Transition } from "framer-motion/types/types";
import { ResolvedValues, VisualElement } from "framer-motion/types/render/types";
...
export declare function getOrigin(target: Target, transition: Transition, visualElement: VisualElement): import("framer-motion/types/types").MakeCustomValueType<{
...
} & import("react").SVGAttributes<SVGElement> & import("framer-motion/types/motion/types").TransformProperties & import("framer-motion/types/motion/types").CustomStyles & import("framer-motion/types/motion/types").SVGPathProperties>;
