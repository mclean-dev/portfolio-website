...
const Portfolio = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("/.netlify/functions/getter", { params: { query: `${query}` } })
      .then((data) => {
  ...
  const handlePortfolioFilter = (item) => {
    ...
    setTimeout(() => {
      ...
      if (item === "All") {
        ...
        setFilterPortfolio(
          portfolio.filter((portfolio) => portfolio.tags.includes(item))
        );
      }
    }, 500);
  };
            ...
            <div className="app__portfolio-img app__flex">
              ...
              <motion.div
                ...
                className={`app__portfolio-hover app__flex ${
                  portfolio.tags.includes("SoundDev") ? "SoundDev" : ""
                }`}
              >
                {portfolio.tags.includes("SoundDev") ? (
                  <></>
                ) : (
                  <>
                    <motion.div
                      ...
                      className="app__flex portfolio-link"
                    >
                      <a
